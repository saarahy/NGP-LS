...
with open(direccion) as spambase:
    ...
    for row in spamReader:
          ...
          datos_y.append(float(row[6]))
#print datos_x
#print datos_y

direccion2="./Engine/data_min.txt"
...
data_save = []
def f1(x0, x1,x2, x3,x4, x5, soluciones): #neat-GP-LS neat-cx
...
f1(asarray(datos_x0),asarray(datos_x1),asarray(datos_x2),asarray(datos_x3),asarray(datos_x4),asarray(datos_x5), soluciones)
np.savetxt('./Engine/data_min_train.csv', data_save, delimiter=",", fmt="%s")
